    ...
    <section className={styles["pasos_container"]}>
      ...
      <div id="paso3" className={styles.paso}>
        ...
        <div>
          <h2>Paso 3</h2>
          <p>
            Luego de haber hechado la cucharada grande de bicarbonato de sodio,
            debemos hecharle el aceite de cocina, hasta llenar casi por completo
            el frasco de vidrio
          </p>
      ...
      <div id="paso4" className={styles.paso}>
        ...
        <div>
          <h2>Paso 4</h2>
          <p>
            Luego de haber llenado el frasco de vidrio con el aceite de cocina,
            en un recipiente aparte hay que revolver un poco de colorante con un
            poco de Vinagre
          </p>
      ...
      <div id="paso5" className={styles.paso}>
        ...
        <div>
          ...
          <p>
            ...
            colorante ya mezclado del paso anterior.
          </p>
